$scriptURL = "https://raw.githubusercontent.com/Atlas2590/script-command/refs/heads/main/sendBackupLog.ps1"
$scriptPath = "$env:ProgramData\BackupNotify\sendBackupLog.ps1"
$taskName = "BackupLogNotify"
﻿# === CONFIGURAZIONE ===
